...
## FILE: para_heatmap.R							 	     #
## DESCRIPTION:									     #
## Rscript to create a heatmap of the parallely generated random matrix		     #
## AUTHOR:									     #
...
## Opening the .tiff file to write the image data
